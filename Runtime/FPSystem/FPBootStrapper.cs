namespace FuzzPhyte.Utility.FPSystem
{
    ...
    public class FPBootStrapper : MonoBehaviour
    {
        public static FPBootStrapper Instance { get; private set; }
        [TextArea(3, 4)]
        ...
        public static void InitializeAfterAwake()
        {
            ...
            var MajorFPSystems = Object.FindObjectsOfType<FPSystemBase>().ToList();
